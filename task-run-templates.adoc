...
* https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-provisioning-storage.html#creating-volumes-from-templates["Cloud Volumes ONTAP ボリュームをプロビジョニングする方法"^]
* https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf-volumes.html#creating-volumes-from-templates["Azure NetApp Files ボリュームをプロビジョニングする方法"^]
